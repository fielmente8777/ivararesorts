  ...
  return (
    <div className="w-full flex flex-col">
      ...
      >
        ...
        {/* Hero Title: Centered Mode or Original Bottom-Left Mode */}
        {centeredTitle ? (
      ...
      {showForm && (
        <SectionWithContainer
          defaultPadding={false}
          sectionClassName="hidden lg:block w-full bg-[#4A5A3E] py-6 px-4 md:px-14 text-white border-t border-[#5b6e4d]"
