    ...
    <footer className="w-full bg-[#4A5A3E] text-white flex flex-col">
      ...
      <div className="w-full bg-[#4A5A3E] py-8 px-4 md:px-14 border-t border-[#5b6e4d]" id="form">
        <div className="max-w-[1320px] mx-auto flex flex-col gap-3">
          ...
          />
          <p className="text-xs text-[#D8C2A5] text-center tracking-wider font-medium mt-1">
      ...
      <div className="w-full bg-[#4A5A3E] py-[56px] px-6 md:px-[60px] border-t border-white/10">
        <div className="max-w-[1440px] mx-auto min-h-[260px] flex flex-col md:flex-row items-start md:items-center justify-between gap-10">
          ...
          <div className="flex flex-col gap-3 items-start text-left max-w-md">
          ...
          <div className="flex flex-col gap-3 items-start text-left flex-shrink-0">
            <h3 className="text-xs font-semibold uppercase tracking-[0.25em] text-[#C4A482]">
              CONTACT
            </h3>
            <div className="flex flex-col items-start gap-2.5 text-sm text-white text-left">
              <Link
