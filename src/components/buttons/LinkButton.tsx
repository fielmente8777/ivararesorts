    ...
    <>
      {href === "#form" ? (
        <button
          ...
          className={`flex items-center justify-center gap-2 shadow-md border w-fit px-4 py-2 hover:scale-95 transition-all duration-300 ease-in-out hover:scale-x-105 active:scale-95 cursor-pointer ${className}`}
          {...props}
        >
        ...
        <Link
          href={href}
          className={`flex items-center justify-center tracking-widest gap-2 shadow-md border w-fit px-4 py-2 hover:scale-95 transition-all duration-300 ease-in-out hover:scale-x-105 active:scale-95 ${className}`}
          {...props}
        >
          {showWhatsApp && <WhatsAppIcon />}
          {callIcon && <CallIcon />}
