...
export default function AboutSection({
  ...
  return (
    <SectionWithContainer
      ...
      sectionClassName="relative bg-[#FAF7F1] py-16 lg:py-24 text-center border-t border-[#EAE3DA] overflow-hidden"
    >
      ...
      <div className="relative z-10 max-w-[948px] mx-auto flex flex-col items-center gap-[24px]">
